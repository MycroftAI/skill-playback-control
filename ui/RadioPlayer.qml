...
Mycroft.CardDelegate {
    ...
    cardBackgroundOverlayColor: sessionData.cardBackgroundColor ? sessionData.cardBackgroundColor : "black"
    cardRadius: 10
    ...
    property color spectrumColorNormal: sessionData.spectrumColor ? sessionData.spectrumColor :  Qt.rgba(1, 1, 1, 0.5)
    property color spectrumColorMid: sessionData.spectrumColor ? sessionData.spectrumColor : spectrumColorNormal
    property color spectrumColorPeak: sessionData.spectrumColor ? sessionData.spectrumColor : Qt.rgba(1, 0, 0, 0.5)
    ...
    Rectangle {
        ...
        Rectangle {
                ...
                anchors.right: parent.right
                anchors.bottom: parent.bottom
                height: (Mycroft.Units.gridUnit * 2) - Kirigami.Units.smallSpacing
                radius: 10
                color: root.seekBackgroundColor
